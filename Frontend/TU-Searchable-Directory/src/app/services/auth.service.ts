...
export class AuthService {
    ...
    logIn(email:string, password: string) {
        const url = 'https://tu-searchable-dir-backend.onrender.com/login';
    ...
    signUp(name:string,email:string, password: string) {
        const url = 'https://tu-searchable-dir-backend.onrender.com/signup';
        // let SALT = '$2a$10$mLmYXYIw9FLvW7d4rXdple';
        // password = bcryptjs.hashSync(password, SALT)
    ...
    adminsignUp(name:string,email:string, password: string) {
        const url = 'https://tu-searchable-dir-backend.onrender.com/adminsignup';
        // let SALT = '$2a$10$mLmYXYIw9FLvW7d4rXdple';
        // password = bcryptjs.hashSync(password, SALT)
